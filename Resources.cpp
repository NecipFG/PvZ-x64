...
bool Sexy::ExtractResourcesByName(ResourceManager* theResourceManager, const char* theName)
{
	...
	else if (!strcmp(theName, "DelayLoad_BackgroundWallKnight"))	return ExtractDelayLoad_BackgroundWallKnightResources(theResourceManager);
...
// DelayLoad_BackgroundWallKnight Resources
Image* Sexy::IMAGE_BACKGROUNDWALLKNIGHT;
bool Sexy::ExtractDelayLoad_BackgroundWallKnightResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDWALLKNIGHT = aMgr.GetImageThrow("IMAGE_BACKGROUNDWALLKNIGHT");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_REANIM_EXPLODONUT_BODY_CRACKED1;
Image* Sexy::IMAGE_REANIM_EXPLODONUT_BODY_CRACKED2;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager* theManager)
{
	...
	try
	{
		...
		IMAGE_REANIM_EXPLODONUT_BODY_CRACKED1 = aMgr.GetImageThrow("IMAGE_REANIM_EXPLODONUT_BODY_CRACKED1");
		IMAGE_REANIM_EXPLODONUT_BODY_CRACKED2 = aMgr.GetImageThrow("IMAGE_REANIM_EXPLODONUT_BODY_CRACKED2");
...
void* gResources[(int)Sexy::ResourceId::RESOURCE_ID_MAX] =
{
	...
	&Sexy::IMAGE_REANIM_EXPLODONUT_BODY_CRACKED1,
	&Sexy::IMAGE_REANIM_EXPLODONUT_BODY_CRACKED2,
	...
	/* DelayLoad_BackgroundWallKnight */
	&Sexy::IMAGE_BACKGROUNDWALLKNIGHT,
