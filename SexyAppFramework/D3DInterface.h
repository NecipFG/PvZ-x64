...
#include <d3d.h>
#else
typedef struct { int dwX; int dwY; int dwWidth; int dwHeight; float dvMinZ; float dvMaxZ; } D3DVIEWPORT7;
#define DDPF_ALPHAPIXELS 0
#define DDPF_RGB 0
#define DDPF_PALETTEINDEXED8 0
#define D3DENUMRET_OK 0
#define D3DENUMRET_CANCEL 0
#define DDSCAPS_TEXTURE 0
#define DDSCAPS2_D3DTEXTUREMANAGE 0
#define DDSCAPS2_TEXTUREMANAGE 0
