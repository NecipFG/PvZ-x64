...
#define BASS_ATTRIB_MUSIC_BPM 0x101
#define BASS_ATTRIB_MUSIC_SPEED 0x102
#define BASS_ATTRIB_MUSIC_VOL_CHAN 0x100
#define BASS_ATTRIB_MUSIC_PSCALER 0x106
...
struct BASS_INSTANCE
{
	...
	BOOL(WINAPI *BASS_Init)(int device, DWORD freq, DWORD flags, HWND win, void* dsguid);
	...
	HMUSIC(WINAPI *BASS_MusicLoad)(BOOL mem, void *file, QWORD offset, DWORD length, DWORD flags, DWORD freq);
	...
	HSAMPLE (WINAPI *BASS_SampleLoad)(BOOL mem, void *file, QWORD offset, DWORD length, DWORD max, DWORD flags);
