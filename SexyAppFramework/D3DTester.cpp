...
#include "D3DTester.h"
using namespace Sexy;
D3DTestImage::D3DTestImage() : mBits(nullptr), mWidth(0), mHeight(0) {}
D3DTestImage::D3DTestImage(int w, int h) : mBits(nullptr), mWidth(0), mHeight(0) {}
D3DTestImage::~D3DTestImage() {}
void D3DTestImage::Create(int, int) {}
void D3DTestImage::FreeImage() {}
const D3DTestImage& D3DTestImage::operator=(const D3DTestImage&) { return *this; }
void D3DTestImage::MakeVerticalBands() {}
void D3DTestImage::FillRect(int, int, int, int, DWORD) {}
void D3DTestImage::CopyToTexture8888(LPDIRECTDRAWSURFACE7, int, int, int, int) {}
void D3DTestImage::CopyToTexture4444(LPDIRECTDRAWSURFACE7, int, int, int, int) {}
void D3DTestImage::DrawPieceToDevice(LPDIRECT3DDEVICE7, LPDIRECTDRAWSURFACE7, float, float, int, int, int, int, DWORD) {}
void D3DTestImage::DrawToDevice(LPDIRECT3DDEVICE7, LPDIRECTDRAWSURFACE7, int, int, DWORD) {}
bool D3DTestImage::CompareEqual(const D3DTestImage&) const { return true; }
int D3DTestImage::ColorDistance(DWORD, DWORD) { return 0; }
bool D3DTestImage::IsUniformColor(DWORD, int&, int, int) const { return true; }
int D3DTestImage::CheckUniformBands(int, int, int, int) { return 0; }

D3DTester::D3DTester() {}
D3DTester::~D3DTester() {}
void D3DTester::CheckDXError(HRESULT, const char*) {}
void D3DTester::SetVidMemoryConstraints(DWORD, DWORD) {}
void D3DTester::TestD3D(HWND, LPDIRECTDRAW7) {}
#endif
