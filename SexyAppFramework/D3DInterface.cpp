...
static void DisplayError(HRESULT theError, const char *theMsg)
{
	...
	if (!hadError)
	{
		...
		if (aResult==IDABORT)
			...
			__asm__("int $3");  // software breakpoint (MSVC _asm → GCC __asm__)
	}
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
bool Sexy::gD3DInterfacePreDrawError = false;
...
bool D3DInterface::CreateImageTexture(MemoryImage *theImage)
{
	...
	if(theImage->mD3DData==NULL)
	{
		...
		AutoCrit aCrit(gSexyAppBase->mCritSect); // Make images thread safe
...
D3DInterface::~D3DInterface() {}
void D3DInterface::Cleanup() {}
void D3DInterface::PushTransform(const SexyMatrix3&, bool) {}
void D3DInterface::PopTransform() {}
bool D3DInterface::PreDraw() { return false; }
void D3DInterface::Flush() {}
void D3DInterface::RemoveMemoryImage(MemoryImage*) {}
bool D3DInterface::CreateImageTexture(MemoryImage*) { return false; }
bool D3DInterface::RecoverBits(MemoryImage*) { return false; }
void D3DInterface::SetCurTexture(MemoryImage*) {}
void D3DInterface::Blt(Image*, float, float, const Rect&, const Color&, int, bool) {}
void D3DInterface::BltClipF(Image*, float, float, const Rect&, const Rect*, const Color&, int) {}
void D3DInterface::BltMirror(Image*, float, float, const Rect&, const Color&, int, bool) {}
void D3DInterface::StretchBlt(Image*, const Rect&, const Rect&, const Rect*, const Color&, int, bool, bool) {}
void D3DInterface::BltRotated(Image*, float, float, const Rect*, const Color&, int, double, float, float, const Rect&) {}
void D3DInterface::BltTransformed(Image*, const Rect*, const Color&, int, const Rect&, const SexyMatrix3&, bool, float, float, bool) {}
void D3DInterface::DrawLine(double, double, double, double, const Color&, int) {}
void D3DInterface::FillRect(const Rect&, const Color&, int) {}
void D3DInterface::DrawTriangle(const TriVertex&, const TriVertex&, const TriVertex&, const Color&, int) {}
void D3DInterface::DrawTriangleTex(const TriVertex&, const TriVertex&, const TriVertex&, const Color&, int, Image*, bool) {}
void D3DInterface::DrawTrianglesTex(const TriVertex[][3], int, const Color&, int, Image*, float, float, bool) {}
void D3DInterface::DrawTrianglesTexStrip(const TriVertex[], int, const Color&, int, Image*, float, float, bool) {}
void D3DInterface::FillPoly(const Point[], int, const Rect*, const Color&, int, int, int) {}
bool D3DInterface::InitFromDDInterface(DDInterface*) { return false; }
void D3DInterface::MakeDDPixelFormat(PixelFormat, DDPIXELFORMAT*) {}
PixelFormat D3DInterface::GetDDPixelFormat(LPDDPIXELFORMAT) { return PixelFormat_Unknown; }
bool D3DInterface::CheckDXError(HRESULT, const char*) { return false; }
#endif
