...
HTTPTransfer::~HTTPTransfer() {}
void HTTPTransfer::Get(const std::string&) {}
void HTTPTransfer::Get(const std::string&, const std::string&) {}
void HTTPTransfer::Post(const std::string&, const std::string&) {}
void HTTPTransfer::Post(const std::string&, const std::string&, const std::string&) {}
void HTTPTransfer::SendRequestString(const std::string&, const std::string&) {}
void HTTPTransfer::Reset() {}
void HTTPTransfer::Abort() {}
void HTTPTransfer::WaitFor() {}
int HTTPTransfer::GetResultCode() { return RESULT_NOT_STARTED; }
std::string HTTPTransfer::GetContent() { return ""; }
#endif
