...
ReanimationParams gLawnReanimationArray[(int)ReanimationType::NUM_REANIMS] = {
    ...
    {ReanimationType::REANIM_LOADBAR_SPROUT, "reanim\\LoadBar_sprout.reanim",
     1},
    {ReanimationType::REANIM_LOADBAR_ZOMBIEHEAD,
     "reanim\\LoadBar_Zombiehead.reanim", 1},
    ...
    {ReanimationType::REANIM_ZOMBIE_FOOTBALL, "reanim\\Zombie_football.reanim",
     0},
    {ReanimationType::REANIM_ZOMBIE_NEWSPAPER, "reanim\\Zombie_paper.reanim",
     0},
    {ReanimationType::REANIM_ZOMBIE_ZAMBONI, "reanim\\Zombie_zamboni.reanim",
     0},
    ...
    {ReanimationType::REANIM_ZOMBIE_CHARRED, "reanim\\Zombie_charred.reanim",
     0},
    {ReanimationType::REANIM_ZOMBIE_CHARRED_IMP,
     "reanim\\Zombie_charred_imp.reanim", 0},
    {ReanimationType::REANIM_ZOMBIE_CHARRED_DIGGER,
     "reanim\\Zombie_charred_digger.reanim", 0},
    {ReanimationType::REANIM_ZOMBIE_CHARRED_ZAMBONI,
     "reanim\\Zombie_charred_zamboni.reanim", 0},
    {ReanimationType::REANIM_ZOMBIE_CHARRED_CATAPULT,
     "reanim\\Zombie_charred_catapult.reanim", 0},
    {ReanimationType::REANIM_ZOMBIE_CHARRED_GARGANTUAR,
     "reanim\\Zombie_charred_gargantuar.reanim", 0},
    ...
    {ReanimationType::REANIM_POLEVAULTER, "reanim\\Zombie_polevaulter.reanim",
     0},
    ...
    {ReanimationType::REANIM_DIGGER_DIRT, "reanim\\Digger_rising_dirt.reanim",
     0},
    {ReanimationType::REANIM_ZOMBIE_DOLPHINRIDER,
     "reanim\\Zombie_dolphinrider.reanim", 0},
    ...
    {ReanimationType::REANIM_BOSS_FIREBALL,
     "reanim\\Zombie_boss_fireball.reanim", 1},
    ...
    {ReanimationType::REANIM_BOSS_DRIVER, "reanim\\Zombie_Boss_driver.reanim",
     0},
    {ReanimationType::REANIM_LAWN_MOWERED_ZOMBIE,
     "reanim\\LawnMoweredZombie.reanim", 0},
    ...
    {ReanimationType::REANIM_SLOT_MACHINE_HANDLE, "reanim\\SlotMachine.reanim",
     0},
    {ReanimationType::REANIM_CREDITS_FOOTBALL,
     "reanim\\Credits_Football.reanim", 1},
    ...
    {ReanimationType::REANIM_ZENGARDEN_SPROUT,
     "reanim\\ZenGarden_sprout.reanim", 0},
    {ReanimationType::REANIM_ZENGARDEN_WATERINGCAN,
     "reanim\\ZenGarden_wateringcan.reanim", 1},
    {ReanimationType::REANIM_ZENGARDEN_FERTILIZER,
     "reanim\\ZenGarden_fertilizer.reanim", 1},
    {ReanimationType::REANIM_ZENGARDEN_BUGSPRAY,
     "reanim\\ZenGarden_bugspray.reanim", 1},
    {ReanimationType::REANIM_ZENGARDEN_PHONOGRAPH,
     "reanim\\ZenGarden_phonograph.reanim", 1},
    ...
    {ReanimationType::REANIM_ZOMBIE_SURPRISE, "reanim\\Zombie_surprise.reanim",
     0},
    ...
    {ReanimationType::REANIM_TREEOFWISDOM_CLOUDS,
     "reanim\\TreeOfWisdomClouds.reanim", 1},
    ...
    {ReanimationType::REANIM_ZOMBIE_CREDITS_DANCE,
     "reanim\\Zombie_credits_dance.reanim", 0},
    {ReanimationType::REANIM_CREDITS_STAGE, "reanim\\Credits_stage.reanim", 1},
    {ReanimationType::REANIM_CREDITS_BIGBRAIN,
     "reanim\\Credits_BigBrain.reanim", 1},
    {ReanimationType::REANIM_CREDITS_FLOWER_PETALS,
     "reanim\\Credits_Flower_petals.reanim", 1},
    {ReanimationType::REANIM_CREDITS_INFANTRY,
     "reanim\\Credits_Infantry.reanim", 1},
    {ReanimationType::REANIM_CREDITS_THROAT, "reanim\\Credits_Throat.reanim",
     1},
    {ReanimationType::REANIM_CREDITS_CRAZYDAVE,
     "reanim\\Credits_CrazyDave.reanim", 1},
    {ReanimationType::REANIM_CREDITS_BOSSDANCE,
     "reanim\\Credits_Bossdance.reanim", 1},
    {ReanimationType::REANIM_ZOMBIE_CREDITS_SCREEN_DOOR,
     "reanim\\Zombie_Credits_Screendoor.reanim", 1},
    {ReanimationType::REANIM_ZOMBIE_CREDITS_CONEHEAD,
     "reanim\\Zombie_Credits_Conehead.reanim", 1},
    {ReanimationType::REANIM_CREDITS_ZOMBIEARMY1,
     "reanim\\Credits_ZombieArmy1.reanim", 1},
    {ReanimationType::REANIM_CREDITS_ZOMBIEARMY2,
     "reanim\\Credits_ZombieArmy2.reanim", 1},
    {ReanimationType::REANIM_CREDITS_TOMBSTONES,
     "reanim\\Credits_Tombstones.reanim", 1},
    {ReanimationType::REANIM_CREDITS_SOLARPOWER,
     "reanim\\Credits_SolarPower.reanim", 1},
...
ReanimatorTransform::ReanimatorTransform()
    : mTransX(DEFAULT_FIELD_PLACEHOLDER), mTransY(DEFAULT_FIELD_PLACEHOLDER),
      ...
      mFrame(DEFAULT_FIELD_PLACEHOLDER), mAlpha(DEFAULT_FIELD_PLACEHOLDER),
      mImage(nullptr), mFont(nullptr), mText("") {}
...
bool ReanimationLoadDefinition(const SexyString &theFileName,
                               ReanimatorDefinition *theDefinition) {
  if (!DefinitionLoadXML(theFileName, &gReanimatorDefMap, theDefinition))
    return false;

  for (int aTrackIndex = 0; aTrackIndex < theDefinition->mTrackCount;
       aTrackIndex++) {
    ...
    for (int i = 0; i < aTrack->mTransformCount; i++) {
      ...
      ReanimationFillInMissingData((void *&)aPrevImage,
                                   (void *&)aTransform.mImage);
      ReanimationFillInMissingData((void *&)aPrevFont,
                                   (void *&)aTransform.mFont);
...
void Reanimation::ReanimationDelete() {
  ...
  if (mTrackInstances != nullptr) {
    ...
    FindGlobalAllocator(aItemSize)->Free(
        mTrackInstances, aItemSize); // 由 TodAllocator 回收动画轨道的内存区域
    mTrackInstances = nullptr;
  }
}

// 0x471A60
void Reanimation::ReanimationInitializeType(float theX, float theY,
...
void ReanimationCreateAtlas(ReanimatorDefinition *theDefinition,
  ...
  if (aDuration > 20 &&
      theReanimationType !=
          ReanimationType::REANIM_NONE) // （仅内测版）创建时间过长的报告
    TodTraceAndLog("LOADING:Long atlas '%s' %d ms on %s",
                   aParam.mReanimFileName, aDuration,
                   gGetCurrentLevelName().c_str());
}

void ReanimationPreload(ReanimationType theReanimationType) {
  TOD_ASSERT(theReanimationType >= 0 &&
             theReanimationType < gReanimatorDefCount);

  ReanimatorDefinition *aReanimDef =
      &gReanimatorDefArray[(int)theReanimationType];
...
void Reanimation::ReanimationInitialize(float theX, float theY,
  ...
  if (theDefinition->mTrackCount != 0) {
    ...
    int aItemSize =
        theDefinition->mTrackCount * sizeof(ReanimatorTrackInstance);
    mTrackInstances =
        (ReanimatorTrackInstance *)FindGlobalAllocator(aItemSize)->Calloc(
            aItemSize); // 申请动画轨道实例数组所需的内存
    for (int aTrackIndex = 0; aTrackIndex < mDefinition->mTrackCount;
...
void Reanimation::Update() {
  ...
  for (int aTrackIndex = 0; aTrackIndex < mDefinition->mTrackCount;
    ...
    {
      aTrack->mShakeX =
          RandRangeFloat(-aTrack->mShakeOverride, aTrack->mShakeOverride);
      aTrack->mShakeY =
          RandRangeFloat(-aTrack->mShakeOverride, aTrack->mShakeOverride);
    }

    if (strnicmp(mDefinition->mTracks[aTrackIndex].mName, "attacher__", 10) ==
        0) // IsAttacher
...
void BlendTransform(ReanimatorTransform *theResult,
  ...
  theResult->mTransX =
      FloatLerp(theTransform1.mTransX, theTransform2.mTransX, theBlendFactor);
  theResult->mTransY =
      FloatLerp(theTransform1.mTransY, theTransform2.mTransY, theBlendFactor);
  theResult->mScaleX =
      FloatLerp(theTransform1.mScaleX, theTransform2.mScaleX, theBlendFactor);
  theResult->mScaleY =
      FloatLerp(theTransform1.mScaleY, theTransform2.mScaleY, theBlendFactor);
  theResult->mAlpha =
      FloatLerp(theTransform1.mAlpha, theTransform2.mAlpha, theBlendFactor);
...
// 0x471F90
void Reanimation::GetCurrentTransform(
    int theTrackIndex, ReanimatorTransform *theTransformCurrent) {
  ReanimatorFrameTime aFrameTime;
  GetFrameTime(&aFrameTime);
  GetTransformAtTime(theTrackIndex, theTransformCurrent,
                     &aFrameTime); // 结合两帧之间的自然补间取得基础变换
      ...
      aTrack->mBlendCounter > 0) // 若当前不为空白帧且轨道处于变换混合过程中
  {
    ...
    BlendTransform(theTransformCurrent, *theTransformCurrent,
...
void Reanimation::GetTransformAtTime(int theTrackIndex,
  ...
  TOD_ASSERT(aTrack->mTransformCount ==
             mDefinition->mTracks[0].mTransformCount);
  ReanimatorTransform &aTransBefore =
      aTrack
          ->mTransforms[theFrameTime->mAnimFrameBeforeInt]; // 前一帧的变换定义
  ReanimatorTransform &aTransAfter =
      aTrack->mTransforms[theFrameTime->mAnimFrameAfterInt]; // 后一帧的变换定义

  theTransform->mTransX = FloatLerp(aTransBefore.mTransX, aTransAfter.mTransX,
                                    theFrameTime->mFraction);
  theTransform->mTransY = FloatLerp(aTransBefore.mTransY, aTransAfter.mTransY,
                                    theFrameTime->mFraction);
  theTransform->mSkewX = FloatLerp(aTransBefore.mSkewX, aTransAfter.mSkewX,
                                   theFrameTime->mFraction);
  theTransform->mSkewY = FloatLerp(aTransBefore.mSkewY, aTransAfter.mSkewY,
                                   theFrameTime->mFraction);
  theTransform->mScaleX = FloatLerp(aTransBefore.mScaleX, aTransAfter.mScaleX,
                                    theFrameTime->mFraction);
  theTransform->mScaleY = FloatLerp(aTransBefore.mScaleY, aTransAfter.mScaleY,
                                    theFrameTime->mFraction);
  theTransform->mAlpha = FloatLerp(aTransBefore.mAlpha, aTransAfter.mAlpha,
                                   theFrameTime->mFraction);
  ...
  if (aTransBefore.mFrame != -1.0f && aTransAfter.mFrame == -1.0f &&
    ...
    theTransform->mFrame =
        -1.0f; // 当从一个非空白帧过渡至空白帧时，若轨道设置了截断消失帧，则删去过渡的过程
  else
...
// 0x472190
void Reanimation::ReanimBltMatrix(Graphics *g, Image *theImage,
  ...
  if (!gSexyAppBase->Is3DAccelerated() && // 未开启 3D 硬件加速
      TestBit(gReanimationParamArray[(int)mReanimationType].mReanimParamFlags,
              (int)ReanimFlags::
                  REANIM_FAST_DRAW_IN_SW_MODE) && // 动画允许使用软件渲染
      FloatApproxEqual(theTransform.m01, 0.0f) &&
      FloatApproxEqual(theTransform.m10, 0.0f) && // 横向和纵向的倾斜值均为 0
      theTransform.m00 > 0.0f &&
      theTransform.m11 > 0.0f && // 横向和纵向的拉伸值均大于 0
      theColor == Color::White) {
    float aScaleX = theTransform.m00;
    float aScaleY = theTransform.m11;
    int aPosX =
        FloatRoundToInt(theTransform.m02 - aScaleX * theSrcRect.mWidth * 0.5f);
    int aPosY =
        FloatRoundToInt(theTransform.m12 - aScaleY * theSrcRect.mHeight * 0.5f);
    ...
    if (FloatApproxEqual(aScaleX, 1.0f) &&
        FloatApproxEqual(aScaleY, 1.0f)) // 如果无拉伸
    ...
    TodBltMatrix(g, theImage, theTransform, theClipRect, theColor, theDrawMode,
                 theSrcRect);
}
...
bool Reanimation::DrawTrack(Graphics *g, int theTrackIndex, int theRenderGroup,
  ...
  ReanimatorTrackInstance *aTrackInstance =
      &mTrackInstances[theTrackIndex];             // 目标轨道的指针
  GetCurrentTransform(theTrackIndex, &aTransform); // 取得当前动画变换
  int aImageFrame =
      FloatRoundToInt(aTransform.mFrame); // 图像在贴图中所处的份数
  ...
  {
    aColor = ColorsMultiply(
        aColor, mColorOverride); // 将轨道颜色与动画的覆写颜色进行正片叠底混合
  }
  if (g->GetColorizeImages()) // 若 Graphics 着色
  {
    aColor = ColorsMultiply(
        aColor, g->GetColor()); // 将颜色再与 Graphics 的颜色进行正片叠底混合
  }
  int aImageAlpha =
      ClampInt(FloatRoundToInt(aTransform.mAlpha * aColor.mAlpha), 0, 255);
  ...
  if (mEnableExtraOverlayDraw) {
    ...
    aExtraOverlayColor.mAlpha =
        ColorComponentMultiply(mExtraOverlayColor.mAlpha, aImageAlpha);
  }
  ...
  if (mDefinition->mReanimAtlas != nullptr &&
      aImage != nullptr) // 如果 atlas 存在且当前变换存在图像（aTransform.mImage
                         // 实际为整数型的图集编号）
  {
    aAtlasImage = mDefinition->mReanimAtlas->GetEncodedReanimAtlas(
        aImage);                // 取得相应的图集数据
    if (aAtlasImage != nullptr) // 如果是合法的图集编号，成功取得对应指针
    {
      aImage =
          aAtlasImage
              ->mOriginalImage; // 将真正的 Sexy::Image* 类型的贴图赋值给 aImage
    }
  ...
  if (aImage !=
      nullptr) // 如果存在贴图。此处若上一步中图集编号非法，则可能导致崩溃
  {
    int aCelWidth = aImage->GetCelWidth();
    int aCelHeight = aImage->GetCelHeight();
    aMatrix.LoadIdentity();
    SexyMatrix3Translation(aMatrix, aCelWidth * 0.5f,
                           aCelHeight *
                               0.5f); // 将矩阵变换的坐标设定在贴图的中心位置
  } else if (aTransform.mFont != nullptr &&
             *aTransform.mText != '\0') // 如果存在字体且文本不为空
  {
    aMatrix.LoadIdentity();
  ...
  if (mDefinition->mReanimAtlas != nullptr &&
      aAtlasImage == nullptr)       // 有 atlas 但不用的情况
    theTriangleGroup->DrawGroup(g); // 先把原有的三角组绘制了

  SexyMatrix3 aTransformMatrix;
  MatrixFromTransform(aTransform, aTransformMatrix);
  SexyMatrix3Multiply(aMatrix, aTransformMatrix,
                      aMatrix); // 以动画变换矩阵作用 aMatrix
  SexyMatrix3Multiply(aMatrix, mOverlayMatrix,
                      aMatrix); // 以动画覆写矩阵作用 aMatrix
  SexyMatrix3Translation(aMatrix, aTrackInstance->mShakeX + g->mTransX - 0.5f,
                         aTrackInstance->mShakeY + g->mTransY -
                             0.5f); // 轨道震动及 g 的影响

  if (aAtlasImage != nullptr) // 如果存在图集（动画定义存在
                              // atlas，轨道变换存在图像，轨道不存在覆写贴图）
  {
    Rect aSrcRect(aAtlasImage->mX, aAtlasImage->mY, aAtlasImage->mWidth,
                  aAtlasImage->mHeight);
    ...
    theTriangleGroup->AddTriangle(g, aImage, aMatrix, aClipRect, aColor,
                                  g->mDrawMode,
                                  aSrcRect); // 向三角组中添加三角形
    if (mEnableExtraAdditiveDraw &&
        !aTrackInstance
             ->mIgnoreExtraAdditiveColor) // 如果动画存在额外叠加颜色且轨道不能无视之
    {
      theTriangleGroup->AddTriangle(g, aImage, aMatrix, aClipRect,
                                    aExtraAdditiveColor,
                                    Graphics::DRAWMODE_ADDITIVE, aSrcRect);
    }
    if (mEnableExtraOverlayDraw) {
      theTriangleGroup->AddTriangle(
          g, FilterEffectGetImage(aImage, FilterEffect::FILTER_EFFECT_WHITE),
          aMatrix, aClipRect, aExtraOverlayColor, Graphics::DRAWMODE_NORMAL,
          aSrcRect);
    }
  } else if (aImage != nullptr) // 如果不存在 atlas 但轨道变换存在图像
  {
    ...
    if (mFilterEffect != FilterEffect::FILTER_EFFECT_NONE) // 如果动画存在滤镜
    {
      aImage = FilterEffectGetImage(aImage,
                                    mFilterEffect); // 将贴图替换为滤镜后的贴图
    }
    ...
    int aCelWidth = aImage->GetCelWidth();
    Rect aSrcRect(aImageFrame * aCelWidth, 0, aCelWidth,
                  aImage->GetCelHeight());
    ReanimBltMatrix(g, aImage, aMatrix, aClipRect, aColor, g->mDrawMode,
                    aSrcRect); // 带矩阵绘制轨道图像
    if (mEnableExtraAdditiveDraw) {
    ...
    if (mEnableExtraOverlayDraw) {
      ...
      ReanimBltMatrix(g, aOverlayImage, aMatrix, aClipRect, aExtraOverlayColor,
             ...
             *aTransform.mText != '\0') // 如果不存在图像但存在文本
  {
...
Image *Reanimation::GetCurrentTrackImage(const char *theTrackName) {
  ...
  if (mDefinition->mReanimAtlas != nullptr &&
      aImage !=
          nullptr) // 如果存在图集且存在图像（否则返回的 aImage 为 nullptr）
  {
    ReanimAtlasImage *aAtlasImage =
        mDefinition->mReanimAtlas->GetEncodedReanimAtlas(
            aImage); // 取得相应的图集数据
...
// 0x472C00
void Reanimation::GetTrackMatrix(int theTrackIndex,
  ...
  if (aImage != nullptr && aImageFrame >= 0) {
    int aCelWidth = aImage->GetCelWidth();
    int aCelHeight = aImage->GetCelHeight();
    SexyMatrix3Translation(theMatrix, aCelWidth * 0.5f,
                           aCelHeight *
                               0.5f); // 将矩阵变换的坐标设定在贴图的中心位置
  ...
  MatrixFromTransform(aTransform, aTransformMatrix);
  SexyMatrix3Multiply(theMatrix, aTransformMatrix,
                      theMatrix); // 以动画变换矩阵作用 theMatrix
  SexyMatrix3Multiply(theMatrix, mOverlayMatrix,
                      theMatrix); // 以动画覆写矩阵作用 theMatrix
...
void Reanimation::GetFrameTime(ReanimatorFrameTime *theFrameTime) {
  TOD_ASSERT(mFrameStart + mFrameCount <=
             mDefinition->mTracks[0].mTransformCount);
  int aFrameCount;
  ...
  if (theFrameTime->mAnimFrameBeforeInt >=
      mFrameStart + mFrameCount - 1) // 如果当前处于结束的一帧
  {
    theFrameTime->mAnimFrameBeforeInt = mFrameStart + mFrameCount - 1;
    theFrameTime->mAnimFrameAfterInt =
        theFrameTime->mAnimFrameBeforeInt; // 将前、后的整数帧均赋值为最后一帧
  } else
...
void Reanimation::DrawRenderGroup(Graphics *g, int theRenderGroup) {
  ...
  for (int aTrackIndex = 0; aTrackIndex < mDefinition->mTrackCount;
    ...
    if (aTrackInstance->mRenderGroup == theRenderGroup) {
      bool aTrackDrawn =
          DrawTrack(g, aTrackIndex, theRenderGroup, &aTriangleGroup);
...
Reanimation::GetTrackInstanceByName(const char *theTrackName) {
...
void Reanimation::AttachToAnotherReanimation(Reanimation *theAttachReanim,
  ...
  if (theAttachReanim->mFrameBasePose == -1)
    theAttachReanim->mFrameBasePose =
        theAttachReanim->mFrameStart; // 将当前动作的起始帧作为变换基准帧
  AttachReanim(
      theAttachReanim->GetTrackInstanceByName(theTrackName)->mAttachmentID,
      this, 0.0f, 0.0f);
}
...
// 0x472FD0
void Reanimation::GetTrackBasePoseMatrix(int theTrackIndex,
                                         SexyTransform2D &theBasePosMatrix) {
...
// 0x473070
AttachEffect *
Reanimation::AttachParticleToTrack(const char *theTrackName,
                                   TodParticleSystem *theParticleSystem,
                                   float thePosX, float thePosY) {
  int aTrackIndex = FindTrackIndex(theTrackName);
  ReanimatorTrackInstance *aTrackInstance = &mTrackInstances[aTrackIndex];
  SexyTransform2D aBasePoseMatrix;
  GetTrackBasePoseMatrix(aTrackIndex,
                         aBasePoseMatrix); // 取得轨道基础形态的变换矩阵
  SexyVector2 aPosition =
      aBasePoseMatrix *
      SexyVector2(thePosX, thePosY); // 以基础形态的矩阵变换位置向量
  return AttachParticle(aTrackInstance->mAttachmentID, theParticleSystem,
                        aPosition.x, aPosition.y);
}

// 0x473110
void Reanimation::GetAttachmentOverlayMatrix(
    int theTrackIndex, SexyTransform2D &theOverlayMatrix) {
  ReanimatorTransform aTransform;
  GetCurrentTransform(theTrackIndex,
                      &aTransform); // 取得含混合、不含覆写的自然变换
  SexyTransform2D aTransformMatrix;
  MatrixFromTransform(aTransform, aTransformMatrix);
  SexyMatrix3Multiply(aTransformMatrix, mOverlayMatrix,
                      aTransformMatrix); // 以动画覆写矩阵作用于动画变换矩阵

  SexyTransform2D aBasePoseMatrix;
  GetTrackBasePoseMatrix(theTrackIndex,
                         aBasePoseMatrix); // 取得轨道基础形态的变换矩阵
  SexyTransform2D aBasePoseMatrixInv;
  SexyMatrix3Inverse(aBasePoseMatrix,
                     aBasePoseMatrixInv); // 取得基础形态矩阵的逆
...
void Reanimation::GetFramesForLayer(const char *theTrackName,
  ...
  for (int j = theFrameStart; j < aTrack->mTransformCount; j++)
    if (aTrack->mTransforms[j].mFrame >= 0.0f)
      theFrameCount =
          j - theFrameStart + 1; // 取从起始帧至轨道最后一个非空白帧之间为帧数量
}
...
void Reanimation::StartBlend(int theBlendTime) {
  for (int aTrackIndex = 0; aTrackIndex < mDefinition->mTrackCount;
    ...
    {
      ReanimatorTrackInstance *aTrackInstance = &mTrackInstances[aTrackIndex];
      aTrackInstance->mBlendTransform =
          aTransform; // 记录当前变换为混合的初始（源）变换
...
void Reanimation::SetShakeOverride(const char *theTrackName,
                                   float theShakeAmount) {
...
// 0x4734B0
void Reanimation::SetTruncateDisappearingFrames(
    const char *theTrackName, bool theTruncateDisappearingFrames) {
  if (theTrackName == nullptr) // 若给出的轨道名称为空指针
  {
    for (int aTrackIndex = 0; aTrackIndex < mDefinition->mTrackCount;
         aTrackIndex++) // 依次设置每一轨道
...
// 0x473590
Reanimation *
ReanimationHolder::AllocReanimation(float theX, float theY, int theRenderOrder,
                                    ReanimationType theReanimationType) {
...
// 0x4735E0
void ReanimatorEnsureDefinitionLoaded(ReanimationType theReanimType,
                                      bool theIsPreloading) {
  TOD_ASSERT(theReanimType >= 0 && theReanimType < gReanimatorDefCount);
  ReanimatorDefinition *aReanimDef = &gReanimatorDefArray[(int)theReanimType];
  if (aReanimDef->mTracks !=
      nullptr) // 如果轨道指针不为空指针，说明定义数据已经加载
    return;
  ReanimationParams *aReanimParams =
      &gReanimationParamArray[(int)theReanimType];
  if (theIsPreloading) {
    if (gSexyAppBase->mShutdown ||
        gAppCloseRequest()) // 预加载时若程序退出，则取消加载
      return;
  }

  PerfTimer aTimer;
  aTimer.Start();
  TodHesitationBracket aHesitation("Load Reanim '%s'",
                                   aReanimParams->mReanimFileName);
  if (!ReanimationLoadDefinition(aReanimParams->mReanimFileName, aReanimDef)) {
    char aBuf[1024];
    sprintf_s<1024U>(aBuf, "Failed to load reanim '%s'",
                     aReanimParams->mReanimFileName);
  ...
  if (aDuration > 100) // （仅内测版）创建时间过长的报告
    TodTraceAndLog("LOADING:Long reanim '%s' %d ms on %s",
                   aReanimParams->mReanimFileName, aDuration,
                   gGetCurrentLevelName().c_str());
}
...
void ReanimatorLoadDefinitions(ReanimationParams *theReanimationParamArray,
  ...
  for (int i = 0; i < gReanimationParamArraySize; i++) {
    ...
    if (DefinitionIsCompiled(
            StringToSexyString(aReanimationParams->mReanimFileName)))
      ReanimatorEnsureDefinitionLoaded(aReanimationParams->mReanimationType,
                                       true);
  }
}
...
float Reanimation::GetTrackVelocity(const char *theTrackName) {
  ...
  return aDis * SECONDS_PER_UPDATE *
         mAnimRate; // 瞬时速率 = 两帧间的横坐标之差 * 一帧的时长 * 动画速率
}
...
bool Reanimation::IsTrackShowing(const char *theTrackName) {
  ...
  return mDefinition->mTracks[aTrackIndex]
             .mTransforms[aFrameTime.mAnimFrameAfterInt]
             .mFrame >= 0.0f; // 返回下一整数帧是否存在图像
}
...
void Reanimation::ShowOnlyTrack(const char *theTrackName) {
  for (int i = 0; i < mDefinition->mTrackCount; i++) {
    ...
    mTrackInstances[i].mRenderGroup =
        stricmp(mDefinition->mTracks[i].mName, theTrackName) == 0
            ? RENDER_GROUP_NORMAL
            : RENDER_GROUP_HIDDEN;
  }
}
...
// 0x4739E0
void Reanimation::AssignRenderGroupToTrack(const char *theTrackName,
                                           int theRenderGroup) {
  for (int i = 0; i < mDefinition->mTrackCount; i++)
    if (stricmp(mDefinition->mTracks[i].mName, theTrackName) == 0) {
      mTrackInstances[i].mRenderGroup =
          theRenderGroup; // 仅设置首个名称恰好为 theTrackName 的轨道
      return;
    }
}

// 0x473A40
void Reanimation::AssignRenderGroupToPrefix(const char *theTrackName,
                                            int theRenderGroup) {
  ...
  for (int i = 0; i < mDefinition->mTrackCount; i++) {
    ...
    if (strlen(aTrackName) >= aPrifixLength &&
        !strnicmp(aTrackName, theTrackName,
                  aPrifixLength)) // 轨道名称长度必须不小于指定前缀长度
...
bool Reanimation::ShouldTriggerTimedEvent(float theEventTime) {
  ...
  if (mFrameCount == 0 || mLastFrameTime <= 0.0f ||
      mAnimRate <= 0.0f) // 没有动画或倒放或未播放
    return false;

  if (mAnimTime >=
      mLastFrameTime) // 一般情况下，可触发的范围为 [mLastFrameTime, mAnimTime]
    return theEventTime >= mLastFrameTime && theEventTime < mAnimTime;
  else // 若动画正好完成一次循环而重新进入下一次循环，则可触发的范围为 [0,
       // mAnimTime] ∪ [mLastFrameTime, 1]
    return theEventTime >= mLastFrameTime || theEventTime < mAnimTime;
}

// 0x473BF0
void Reanimation::PlayReanim(const char *theTrackName,
                             ReanimLoopType theLoopType, int theBlendTime,
                             float theAnimRate) {
...
void Reanimation::ParseAttacherTrack(const ReanimatorTransform &theTransform,
  ...
  const char *aReanimName =
      strstr(theTransform.mText, "__"); // 指向动画名称前的双下划线
  if (aReanimName == nullptr)           // 如果字符串中不含双下划线
    return;
  const char *aTags =
      strstr(aReanimName + 2, "["); // 动画名称之后，指向 TAG 前的中括号
  ...
  if (aTrackName) // 如果有定义轨道名称
  {
    ...
    if (aTags)                         // 如果有定义标签
      theAttacherInfo.mTrackName.assign(
          aTrackName + 2, aTags - aTrackName - 2); // 取到 TAG 的中括号之前
    else
    ...
    theAttacherInfo.mReanimName.assign(aReanimName +
                                       2); // 从双下划线之后取到字符串结尾
...
// 0x473EB0
void Reanimation::AttacherSynchWalkSpeed(int theTrackIndex,
                                         Reanimation *theAttachReanim,
                                         AttacherInfo &theAttacherInfo) {
  ReanimatorTrack *aTrack = &mDefinition->mTracks[theTrackIndex];
  ReanimatorFrameTime aFrameTime;
  GetFrameTime(&aFrameTime);
  ...
  ReanimatorTransform &aPlaceHolderStartTrans =
      aTrack->mTransforms[aPlaceHolderFrameStart];
  ReanimatorTransform &aPlaceHolderEndTrans =
      aTrack->mTransforms[aPlaceHolderFrameEnd];
  ...
  float aPlaceHolderDistance =
      -(aPlaceHolderEndTrans.mTransX -
        aPlaceHolderStartTrans.mTransX); // 占位轨道在当前区间内的位移
  float aPlaceHolderSeconds =
      aPlaceHolderFrameCount / mAnimRate; // 占位轨道在当前区间内的时长
  if (FloatApproxEqual(aPlaceHolderSeconds,
                       0.0f)) // 如果当前所在区间不存在任何帧
  {
  ...
  ReanimatorTrack *aGroundTrack =
      &theAttachReanim->mDefinition->mTracks[aGroundTrackIndex];
  ...
  ReanimatorTransform &aTransformGuyEnd =
      aGroundTrack->mTransforms[theAttachReanim->mFrameStart +
                                theAttachReanim->mFrameCount - 1];
  float aGuyDistance =
      aTransformGuyEnd.mTransX -
      aTransformGuyStart.mTransX; // 实际动画在完整动作周期内的位移
  if (aGuyDistance < FLT_EPSILON ||
      aPlaceHolderDistance <
          FLT_EPSILON) // 如果占位位移为 0 或实际动画周期位移为
                       // 0，则附属动画无法移动
  {
    theAttachReanim->mAnimRate = 0.0f; // 附属动画的速率为 0
    return;
  ...
  theAttachReanim->GetCurrentTransform(aGroundTrackIndex,
                                       &aTransformGuyCurrent);
  AttachEffect *aAttachEffect =
      FindFirstAttachment(mTrackInstances[theTrackIndex].mAttachmentID);
  if (aAttachEffect != nullptr) {
    float aGuyCurrentDistance =
        aTransformGuyCurrent.mTransX -
        aTransformGuyStart.mTransX; // 附属动画在其周期内当前已经过的位移
    float aGuyExpectedDistance =
        aGuyDistance *
        theAttachReanim
            ->mAnimTime; // 以匀速运动的占位轨道计算的、附属动画当前的理论位移
    aAttachEffect->mOffset.m02 =
        aGuyExpectedDistance -
        aGuyCurrentDistance; // 调整附属效果的横向变换以使附属动画的位移保持与占位动画一致
  }
  theAttachReanim->mAnimRate =
      aLoops * theAttachReanim->mFrameCount /
      aPlaceHolderSeconds; // 速率 = 需要播放的帧数 ÷ 可以播放的时长
}
...
void Reanimation::UpdateAttacherTrack(int theTrackIndex) {
  ...
  if (aAttacherInfo.mReanimName.size() !=
      0) // 如果附属轨道设定了当前的附属动画名称
  {
    std::string aReanimFileName =
        StrFormat("reanim\\%s.reanim", aAttacherInfo.mReanimName.c_str());
    for (int i = 0; i < gReanimationParamArraySize;
         i++) // 在动画参数数组中寻找动画文件名对应的动画类型
    {
  ...
  if (aReanimationType ==
      ReanimationType::
          REANIM_NONE) // 如果没有设定当前附属动画名称，或未找到相应的动画
  {
    AttachmentDie(aTrackInstance->mAttachmentID); // 清除附件
    return;
  }

  Reanimation *aAttachReanim =
      FindReanimAttachment(aTrackInstance->mAttachmentID);
  if (aAttachReanim == nullptr ||
      aAttachReanim->mReanimationType !=
          aReanimationType) // 如果原先没有附属动画，或原附属动画不是上述设定的动画
  {
  ...
  if (aAttacherInfo.mTrackName.size() != 0) // 如果定义了附属动画的动作轨道
  {
    ...
    aAttachReanim->GetFramesForLayer(aAttacherInfo.mTrackName.c_str(),
                                     aAnimFrameStart, aAnimFrameCount);
    if (aAttachReanim->mFrameStart != aAnimFrameStart ||
        aAttachReanim->mFrameCount !=
            aAnimFrameCount) // if (!aAttachReanim->IsAnimPlaying(……))
    {
      aAttachReanim->StartBlend(20);
      aAttachReanim->SetFramesForLayer(
          aAttacherInfo.mTrackName.c_str()); // 播放指定轨道上的动作
    }
  ...
  aColor.mAlpha =
      ClampInt(FloatRoundToInt(aTransform.mAlpha * aColor.mAlpha), 0, 255);
  AttachmentPropogateColor(aTrackInstance->mAttachmentID, aColor,
                           mEnableExtraAdditiveDraw, mExtraAdditiveColor,
                           mEnableExtraOverlayDraw, mExtraOverlayColor);
}
...
Reanimation *Reanimation::FindSubReanim(ReanimationType theReanimType) {
  ...
  for (int i = 0; i < mDefinition->mTrackCount; i++) {
    Reanimation *aReanimation =
        FindReanimAttachment(mTrackInstances[i].mAttachmentID);
