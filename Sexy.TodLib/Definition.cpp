...
DefField gTrailDefFields[] = {  //0x69E160
    { "Image", 0x0, offsetof(TrailDefinition, mImage), DefFieldType::DT_IMAGE, nullptr },
    { "MaxPoints", 0x4, offsetof(TrailDefinition, mMaxPoints), DefFieldType::DT_INT, nullptr },
    { "MinPointDistance", 0x8, offsetof(TrailDefinition, mMinPointDistance), DefFieldType::DT_FLOAT, nullptr },
    { "TrailFlags", 0xC, offsetof(TrailDefinition, mTrailFlags), DefFieldType::DT_FLAGS, gTrailFlagDefSymbols },
    { "WidthOverLength", 0x18, offsetof(TrailDefinition, mWidthOverLength), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "WidthOverTime", 0x20, offsetof(TrailDefinition, mWidthOverTime), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "AlphaOverLength", 0x28, offsetof(TrailDefinition, mAlphaOverLength), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "AlphaOverTime", 0x30, offsetof(TrailDefinition, mAlphaOverTime), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "TrailDuration", 0x10, offsetof(TrailDefinition, mTrailDuration), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "", 0x0, offsetof(TrailDefinition, mImage), DefFieldType::DT_INVALID, nullptr }
};
DefMap gTrailDefMap = { gTrailDefFields, 0x38, sizeof(TrailDefinition), TrailDefinitionConstructor };  //0x69D98C
...
DefField gParticleFieldDefFields[] = {  //0x69E2F8
    { "FieldType", 0x0, offsetof(ParticleField, mFieldType), DefFieldType::DT_ENUM, gParticleTypeSymbols },
    { "x", 0x4, offsetof(ParticleField, mX), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "y", 0xC, offsetof(ParticleField, mY), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "", 0x0, offsetof(ParticleField, mFieldType), DefFieldType::DT_INVALID, nullptr },
};
DefMap gParticleFieldDefMap = { gParticleFieldDefFields, 0x14, sizeof(ParticleField), ParticleFieldConstructor };  //0x69E338

DefField gEmitterDefFields[] = {  //0x69E350
    { "Image", 0x0, offsetof(TodEmitterDefinition, mImage), DefFieldType::DT_IMAGE, nullptr },
    { "ImageRow", 0x8, offsetof(TodEmitterDefinition, mImageRow), DefFieldType::DT_INT, nullptr },
    { "ImageCol", 0x4, offsetof(TodEmitterDefinition, mImageCol), DefFieldType::DT_INT, nullptr },
    { "ImageFrames", 0xC, offsetof(TodEmitterDefinition, mImageFrames), DefFieldType::DT_INT, nullptr },
    { "Animated", 0x10, offsetof(TodEmitterDefinition, mAnimated), DefFieldType::DT_INT, nullptr },
    { "ParticleFlags", 0x14, offsetof(TodEmitterDefinition, mParticleFlags), DefFieldType::DT_FLAGS, gParticleFlagSymbols },
    { "EmitterType", 0x18, offsetof(TodEmitterDefinition, mEmitterType), DefFieldType::DT_ENUM, gEmitterTypeSymbols },
    { "Name", 0x1C, offsetof(TodEmitterDefinition, mName), DefFieldType::DT_STRING, nullptr },
    { "SystemDuration", 0x24, offsetof(TodEmitterDefinition, mSystemDuration), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "OnDuration", 0x20, offsetof(TodEmitterDefinition, mOnDuration), DefFieldType::DT_STRING, nullptr },
    { "CrossFadeDuration", 0x2C, offsetof(TodEmitterDefinition, mCrossFadeDuration), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SpawnRate", 0x34, offsetof(TodEmitterDefinition, mSpawnRate), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SpawnMinActive", 0x3C, offsetof(TodEmitterDefinition, mSpawnMinActive), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SpawnMaxActive", 0x44, offsetof(TodEmitterDefinition, mSpawnMaxActive), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SpawnMaxLaunched", 0x4C, offsetof(TodEmitterDefinition, mSpawnMaxLaunched), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterRadius", 0x54, offsetof(TodEmitterDefinition, mEmitterRadius), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterOffsetX", 0x5C, offsetof(TodEmitterDefinition, mEmitterOffsetX), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterOffsetY", 0x64, offsetof(TodEmitterDefinition, mEmitterOffsetY), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterBoxX", 0x6C, offsetof(TodEmitterDefinition, mEmitterBoxX), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterBoxY", 0x74, offsetof(TodEmitterDefinition, mEmitterBoxY), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterPath", 0x8C, offsetof(TodEmitterDefinition, mEmitterPath), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterSkewX", 0x7C, offsetof(TodEmitterDefinition, mEmitterSkewX), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "EmitterSkewY", 0x84, offsetof(TodEmitterDefinition, mEmitterSkewY), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleDuration", 0x94, offsetof(TodEmitterDefinition, mParticleDuration), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SystemRed", 0xAC, offsetof(TodEmitterDefinition, mSystemRed), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SystemGreen", 0xB4, offsetof(TodEmitterDefinition, mSystemGreen), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SystemBlue", 0xBC, offsetof(TodEmitterDefinition, mSystemBlue), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SystemAlpha", 0xC4, offsetof(TodEmitterDefinition, mSystemAlpha), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "SystemBrightness", 0xCC, offsetof(TodEmitterDefinition, mSystemBrightness), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "LaunchSpeed", 0x9C, offsetof(TodEmitterDefinition, mLaunchSpeed), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "LaunchAngle", 0xA4, offsetof(TodEmitterDefinition, mLaunchAngle), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "Field", 0xD4, offsetof(TodEmitterDefinition, mParticleFields), DefFieldType::DT_ARRAY, &gParticleFieldDefMap },
    { "SystemField", 0xDC, offsetof(TodEmitterDefinition, mSystemFields), DefFieldType::DT_ARRAY, &gParticleFieldDefMap },
    { "ParticleRed", 0xE4, offsetof(TodEmitterDefinition, mParticleRed), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleGreen", 0xEC, offsetof(TodEmitterDefinition, mParticleGreen), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleBlue", 0xF4, offsetof(TodEmitterDefinition, mParticleBlue), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleAlpha", 0xFC, offsetof(TodEmitterDefinition, mParticleAlpha), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleBrightness", 0x104, offsetof(TodEmitterDefinition, mParticleBrightness), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleSpinAngle", 0x10C, offsetof(TodEmitterDefinition, mParticleSpinAngle), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleSpinSpeed", 0x114, offsetof(TodEmitterDefinition, mParticleSpinSpeed), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleScale", 0x11C, offsetof(TodEmitterDefinition, mParticleScale), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ParticleStretch", 0x124, offsetof(TodEmitterDefinition, mParticleStretch), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "CollisionReflect", 0x12C, offsetof(TodEmitterDefinition, mCollisionReflect), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "CollisionSpin", 0x134, offsetof(TodEmitterDefinition, mCollisionSpin), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ClipTop", 0x13C, offsetof(TodEmitterDefinition, mClipTop), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ClipBottom", 0x144, offsetof(TodEmitterDefinition, mClipBottom), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ClipLeft", 0x14C, offsetof(TodEmitterDefinition, mClipLeft), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "ClipRight", 0x154, offsetof(TodEmitterDefinition, mClipRight), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "AnimationRate", 0x15C, offsetof(TodEmitterDefinition, mAnimationRate), DefFieldType::DT_TRACK_FLOAT, nullptr },
    { "", 0x0, offsetof(TodEmitterDefinition, mImage), DefFieldType::DT_INVALID, nullptr },
};
DefMap gEmitterDefMap = { gEmitterDefFields, 0x164, sizeof(TodEmitterDefinition), TodEmitterDefinitionConstructor };  //0x69E344

DefField gParticleDefFields[] = {  //0x69E670
    { "Emitter", 0x0, offsetof(TodParticleDefinition, mEmitterDefs), DefFieldType::DT_ARRAY, &gEmitterDefMap },
    { "", 0x0, offsetof(TodParticleDefinition, mEmitterDefs), DefFieldType::DT_INVALID, nullptr }
};
DefMap gParticleDefMap = { gParticleDefFields, 0x8, sizeof(TodParticleDefinition), TodParticleDefinitionConstructor };  //0x69E690

DefField gReanimatorTransformDefFields[] = {  //0x69F088
    { "x", 0x0, offsetof(ReanimatorTransform, mTransX), DefFieldType::DT_FLOAT, nullptr },
    { "y", 0x4, offsetof(ReanimatorTransform, mTransY), DefFieldType::DT_FLOAT, nullptr },
    { "kx", 0x8, offsetof(ReanimatorTransform, mSkewX), DefFieldType::DT_FLOAT, nullptr },
    { "kx", 0xC, offsetof(ReanimatorTransform, mSkewY), DefFieldType::DT_FLOAT, nullptr },
    { "sx", 0x10, offsetof(ReanimatorTransform, mScaleX), DefFieldType::DT_FLOAT, nullptr },
    { "sx", 0x14, offsetof(ReanimatorTransform, mScaleY), DefFieldType::DT_FLOAT, nullptr },
    { "f", 0x18, offsetof(ReanimatorTransform, mFrame), DefFieldType::DT_FLOAT, nullptr },
    { "a", 0x1C, offsetof(ReanimatorTransform, mAlpha), DefFieldType::DT_FLOAT, nullptr },
    { "i", 0x20, offsetof(ReanimatorTransform, mImage), DefFieldType::DT_IMAGE, nullptr },
    { "font", 0x24, offsetof(ReanimatorTransform, mFont), DefFieldType::DT_FONT, nullptr },
    { "text", 0x28, offsetof(ReanimatorTransform, mText), DefFieldType::DT_STRING, nullptr },
    { "", 0x0, offsetof(ReanimatorTransform, mTransX), DefFieldType::DT_INVALID, nullptr }
};
DefMap gReanimatorTransformDefMap = { gReanimatorTransformDefFields, 0x2C, sizeof(ReanimatorTransform), nullptr };  //0x69F07C

DefField gReanimatorTrackDefFields[] = {  //0x69F148
    { "name", 0x0, offsetof(ReanimatorTrack, mName), DefFieldType::DT_STRING, nullptr },
    { "t", 0x4, offsetof(ReanimatorTrack, mTransforms), DefFieldType::DT_ARRAY, &gReanimatorTransformDefMap },
    { "", 0x0, offsetof(ReanimatorTrack, mName), DefFieldType::DT_INVALID, nullptr }
};
DefMap gReanimatorTrackDefMap = { gReanimatorTrackDefFields, 0xc, sizeof(ReanimatorTrack), ReanimatorTrackConstructor };  //0x69F178

DefField gReanimatorDefFields[] = {
    { "track", 0x0, offsetof(ReanimatorDefinition, mTracks), DefFieldType::DT_ARRAY, &gReanimatorTrackDefMap },
    { "fps", 0x8, offsetof(ReanimatorDefinition, mFPS), DefFieldType::DT_FLOAT, nullptr },
    { "", 0x0, offsetof(ReanimatorDefinition, mTracks), DefFieldType::DT_INVALID, nullptr }
};  //0x69F184
DefMap gReanimatorDefMap = { gReanimatorDefFields, 0x10, sizeof(ReanimatorDefinition), ReanimatorDefinitionConstructor };  //0x69F1B4
...
void SMemR(void*& _Src, void* _Dest, size_t _Size)
{
...
{
    int aDefSizeOnDisk;
    SMemR(theReadPtr, &aDefSizeOnDisk, sizeof(int));
    if (aDefSizeOnDisk != theDefMap->mDefSize)
    {
    ...
    int aArraySizeMemory = theDefMap->mMemorySize * theArray->mArrayCount;
    void* pData = DefinitionAlloc(aArraySizeMemory);
    memset(pData, 0, aArraySizeMemory);
    theArray->mArrayData = pData;

    int aTotalBlobSize = theDefMap->mDefSize * theArray->mArrayCount;
    std::vector<char> aBulkBlobs(aTotalBlobSize);
    SMemR(theReadPtr, aBulkBlobs.data(), aTotalBlobSize);

    for (int i = 0; i < theArray->mArrayCount; i++)
    {
        void* aElemBlob = (void*)((intptr_t)aBulkBlobs.data() + theDefMap->mDefSize * i);
        void* aElemDest = (void*)((intptr_t)pData + theDefMap->mMemorySize * i);

        if (theDefMap->mConstructorFunc)
            theDefMap->mConstructorFunc(aElemDest);

        for (DefField* aField = theDefMap->mMapFields; aField->mFieldName != nullptr && *aField->mFieldName != '\0'; aField++)
        {
            void* aSrc = (void*)((intptr_t)aElemBlob + aField->mFieldOffset);
            void* aDest = (void*)((intptr_t)aElemDest + aField->mMemoryOffset);
            ...
            case DefFieldType::DT_FLOAT:
                *(float*)aDest = *(float*)aSrc;
                break;
            case DefFieldType::DT_VECTOR2:
                *(SexyVector2*)aDest = *(SexyVector2*)aSrc;
                break;
            case DefFieldType::DT_ARRAY:
                ((DefinitionArrayDef*)aDest)->mArrayCount = *(int*)((intptr_t)aSrc + 4);
                break;
            default:
                break;
            }
...
bool DefReadFromCacheImage(void*& theReadPtr, Image** theImage)
{
    ...
    std::vector<char> aBuffer(aLen + 1, '\0');
    SMemR(theReadPtr, aBuffer.data(), aLen);

    *theImage = nullptr;
    return aBuffer[0] == '\0' || DefinitionLoadImage(theImage, aBuffer.data());
}
...
bool DefReadFromCacheFont(void*& theReadPtr, Font** theFont)
{
    ...
    *theFont = nullptr;
    return aBuffer[0] == '\0' || DefinitionLoadFont(theFont, aBuffer.data());
}

//0x4442C0
bool DefMapReadFromCache(void*& theReadPtr, DefMap* theDefMap, void* theDefinition)
{
    std::vector<char> aTemp32Buffer(theDefMap->mDefSize);
    SMemR(theReadPtr, aTemp32Buffer.data(), theDefMap->mDefSize);

    for (DefField* aField = theDefMap->mMapFields; aField->mFieldName != nullptr && *aField->mFieldName != '\0'; aField++)
    {
        bool aSucceed = true;
        void* aSrc = (void*)((intptr_t)aTemp32Buffer.data() + aField->mFieldOffset);
        void* aDest = (void*)((intptr_t)theDefinition + aField->mMemoryOffset);
...
void* DefinitionUncompressCompiledBuffer(void* theCompressedBuffer, size_t theCompressedBufferSize, size_t& theUncompressedSize, const SexyString& theCompiledFilePath)
{
    ...
    uLongf aUncompressedLen = aHeader->mUncompressedSize;
    Bytef* aSrc = (Bytef*)((intptr_t)theCompressedBuffer + sizeof(CompressedDefinitionHeader));  // 实际解压数据从第 3 个四字节开始
    int aResult = uncompress(aUncompressedBuffer, &aUncompressedLen, aSrc, sz - sizeof(CompressedDefinitionHeader));
    TOD_ASSERT(aResult == Z_OK);
    TOD_ASSERT(aUncompressedLen == aHeader->mUncompressedSize);
    theUncompressedSize = aUncompressedLen;
        ...
        else
        {
            ...
            if (aUncompressedBuffer)
            {
                ...
                else
                {
                    ...
                    {
                        fprintf(stderr, "Compiled file schema wrong: %s (read: 0x%08X, calc: 0x%08X)\n", theCompiledFilePath.c_str(), aCashHash, aDefHash);
                        TodTrace(_S("Compiled file schema wrong: %s\n"), theCompiledFilePath.c_str());
                    }
                    else
                    {
                        // ☆ Officially started reading definition data ☆
                        // In 64-bit, we skip the bulk gulp and let DefMapReadFromCache handle the layout transformation.
...
#else
    struct stat aCompiledStat, aXMLStat;
    bool aSucceed = stat(aCompiledFilePath.c_str(), &aCompiledStat) == 0;
    if (stat(theXMLFilePath.c_str(), &aXMLStat) != 0)
    {
        TodTrace(_S("Can't find source file to compile '%s'"), theXMLFilePath.c_str());
        return true;
    }
    return aSucceed && (aCompiledStat.st_mtime > aXMLStat.st_mtime);
#endif
}
//0x444580
void DefinitionFillWithDefaults(DefMap* theDefMap, void* theDefinition)
{
    memset(theDefinition, NULL, theDefMap->mMemorySize);
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++)
        if (aField->mFieldType == DefFieldType::DT_STRING)
            *(char**)((uintptr_t)theDefinition + aField->mMemoryOffset) = "";
}
...
bool DefinitionReadStringField(XMLParser* theXmlParser, char** theValue)
{
    ...
    size_t stringLength = aStringValue.size();
    *theValue = (char*)DefinitionAlloc(stringLength + 1);
    memcpy(*theValue, aStringValue.c_str(), stringLength);
    (*theValue)[stringLength] = '\0'; // Manually ensure absolute null-termination
    return true;
}
...
bool DefinitionReadField(XMLParser* theXmlParser, DefMap* theDefMap, void* theDefinition, bool* theDone)
{
    ...
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++)
    {
        void* pVar = (void*)((uintptr_t)theDefinition + aField->mMemoryOffset);
...
{
    for (int i = 0; i < theArray->mArrayCount; i++)
        DefinitionFreeMap(theDefMap, (void*)((intptr_t)theArray->mArrayData + theDefMap->mMemorySize * i));  // 最后一个参数表示 pData[i]
...
void DefinitionFreeMap(DefMap* theDefMap, void* theDefinition)
{
    ...
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++)
    {
        void* aVar = (void*)((intptr_t)theDefinition + aField->mMemoryOffset);  // 指向该成员变量的指针
        switch (aField->mFieldType)
        {
        case DefFieldType::DT_STRING:
            if (*(char**)aVar != nullptr && **(char**)aVar != '\0')
