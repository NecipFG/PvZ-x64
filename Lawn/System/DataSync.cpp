...
{
	unsigned long aVal = (unsigned char)theNum;
	SyncLong(aVal);
	if (mReader) theNum = (char)(unsigned char)aVal;
}

void DataSync::SyncLong(short& theNum)
{
	unsigned long aVal = (unsigned short)theNum;
	SyncLong(aVal);
	if (mReader) theNum = (short)(unsigned short)aVal;
}

void DataSync::SyncLong(long& theNum)
{
	unsigned long aVal = (unsigned long)theNum;
	SyncLong(aVal);
	if (mReader) theNum = (long)(int)aVal;
}

void DataSync::SyncLong(unsigned char& theNum)
{
	unsigned long aVal = theNum;
	SyncLong(aVal);
	if (mReader) theNum = (unsigned char)aVal;
}
...
void DataSync::SyncLong(unsigned short& theNum)
{
	unsigned long aVal = theNum;
	SyncLong(aVal);
	if (mReader) theNum = (unsigned short)aVal;
}

void DataSync::SyncLong(int& theNum)
{
	unsigned long aVal = (unsigned int)theNum;
	SyncLong(aVal);
	if (mReader) theNum = (int)aVal;
}

void DataSync::SyncLong(unsigned int& theNum)
{
	unsigned long aVal = theNum;
	SyncLong(aVal);
	if (mReader) theNum = (unsigned int)aVal;
}
...
void DataSync::SyncSLong(long& theNum)
{
	if (mReader)
	{
		theNum = (long)(int32_t)mReader->ReadLong();
	}
	else
	{
...
{
	long aVal = (long)theNum;
	SyncSLong(aVal);
	if (mReader) theNum = (char)aVal;
}
...
void DataSync::SyncSLong(unsigned long& theNum)
{
	long aVal = (long)theNum;
	SyncSLong(aVal);
	if (mReader) theNum = (unsigned long)aVal;
}
...
{
	unsigned short aVal = (unsigned short)theNum;
	SyncShort(aVal);
	if (mReader) theNum = (short)aVal;
}
...
void DataSync::SyncShort(long& theNum)
{
	unsigned short aVal = (unsigned short)theNum;
	SyncShort(aVal);
	if (mReader) theNum = (long)aVal;
}

void DataSync::SyncShort(unsigned char& theNum)
{
	unsigned short aVal = theNum;
	SyncShort(aVal);
	if (mReader) theNum = (unsigned char)aVal;
}
...
{
	unsigned int aVal = (unsigned int)theLong;
	WriteBytes(&aVal, sizeof(aVal));
}
