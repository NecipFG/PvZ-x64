...
public:
    ...
    Plant*                  mWallKnight;
    float                   mWallKnightX, mWallKnightY;
    int                     mWallKnightAttackCounter;
    int                     mWallKnightBuffs[NUM_WALLKNIGHT_BUFFS];
    int                     mLastWaveBuffAwarded;
    int                     mWallKnightRainCounter;
...
public:
    ...
    void                    UpdateWallKnight();
    void                    WallKnightKeyDown(KeyCode theKey);
    void                    DoWallKnightBuffSelection();
