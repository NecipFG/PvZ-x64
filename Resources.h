...
namespace Sexy
{
    ...
    enum class ResourceId : int
    {
        ...
        IMAGE_REANIM_EXPLODONUT_BODY_CRACKED1_ID,
        IMAGE_REANIM_EXPLODONUT_BODY_CRACKED2_ID,
    ...
    extern Image*       IMAGE_REANIM_EXPLODONUT_BODY_CRACKED1;                  //0x6A7204
    extern Image*       IMAGE_REANIM_EXPLODONUT_BODY_CRACKED2;                  //0x6A7208
    ...
    extern Image*       IMAGE_BACKGROUNDWALLKNIGHT;                             //0x6A7684
    extern Image*       IMAGE_REANIM_DIAMOND;                                   //0x6A7688
    extern Image*       IMAGE_PRESENTOPEN;                                      //0x6A768C
    extern Image*       IMAGE_POOL_SHADING;                                     //0x6A7690
    extern Image*       IMAGE_REANIM_ZOMBIE_SCREENDOOR3;                        //0x6A7694
    extern Image*       IMAGE_REANIM_ZOMBIE_GARGANTUAR_HEAD2_REDEYE;            //0x6A7698
    ...
    bool                ExtractDelayLoad_BackgroundWallKnightResources(ResourceManager* theResourceManager);
